...
model = load_vla(
        ...
        '/home/namikosaito/work/exp/test_exp--image_aug/checkpoints/step-001000-epoch-333-loss=0.0708.pt',
...
image: Image.Image = Image.open("frame/frame_00001.png")     
...
pd.DataFrame(actions).to_csv("action.csv", index=False, header=False